...
Reference full template: `F:/Projects/blindtest_2000/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Projects/blindtest_2000/.claude/gsd-core/templates/state.md`.
