...
<!-- For checkpoint task examples and patterns, see @F:/Projects/blindtest_2000/.claude/gsd-core/references/checkpoints.md -->
...
See `F:/Projects/blindtest_2000/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `F:/Projects/blindtest_2000/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `F:/Projects/blindtest_2000/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
