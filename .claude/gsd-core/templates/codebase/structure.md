...
- Usage: Reference from command with `@F:/Projects/blindtest_2000/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to F:/Projects/blindtest_2000/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to F:/Projects/blindtest_2000/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
