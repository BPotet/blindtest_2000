...
```
Agent(
  prompt="Read F:/Projects/blindtest_2000/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/Projects/blindtest_2000/.claude/gsd-core/templates/VALIDATION.md`
